...
class GameScene: SKScene {
    ...
    func spawnEnemies() {
        ...
        let enemiesDistance = self.player.size.height * 3.5
    ...
    func gameOver() {
        ...
        Timer.scheduledTimer(withTimeInterval: 1.0, repeats: false) { (timer) in let gameOverLabel = SKLabelNode(fontNamed: "Chalkduster")
